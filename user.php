        ...
        <div class="card-body">
            <div class='row'>
                <div class='col d-flex justify-content-end'>
                    <button class='btn btn-primary' data-bs-toggle="modal" data-bs-target="#ModalInputUser"> Tambah
                        User</button>
                </div>
            </div>
            <!-- Modal Tambah User Baru -->
            <div class="modal fade" id="ModalInputUser" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput"
                                                placeholder="Nama Kamu Broo" name="name" required>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            <select class="form-select" aria-label="Default select example"
                                                name="pilih_level" required>
                                                <option selected hidden value="">Pilih Level</option>
                                                <option value="1"> Admin</option>
                                                <option value="2"> Staff</option>
                                                <option value="3"> User</option>
                                                <option value="4"> Servant</option>
                                            </select>
                                            <label for="floatingInput"> Level User</label>
                                            <div class="invalid-feedback">
                                                Pilih level User dulu!
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-floating mb-3">
                                                <input disabled type="text" class="form-control" id="floatingInput"
                                                    placeholder="Nama Kamu Broo" name="name"
                                                    value="<?php echo $row['nama'] ?>">
                                                <label for="floatingInput"> Nama mu broo</label>
                                                <div class="invalid-feedback">
                                                    Masukkan Nama
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-floating mb-3">
                                                ...
                                                <label for="floatingInput"> Username juga</label>
                                                <div class="invalid-feedback">
                                                    Masukkan Username
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-floating mb-3">
                                                <select disabled class="form-select" aria-label="Default select example"
                                                    ...
                                                    <?php
                                                    $data = array("Admin", "Staff", "User", "Servant");
                                ...
                                <form class="needs-validation" novalidate action="proses/proses_edit_user.php"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="floatingInput"
                                                    placeholder="Nama Kamu Broo" name="nama" required
                                                    value="<?php echo $row['nama'] ?>">
                                                <label for="floatingInput"> Nama mu broo</label>
                                                <div class="invalid-feedback">
                                                    Masukkan Nama
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-floating mb-3">
                                                <input <?php echo ($row['username'] == $_SESSION['username_altaca']) ? 'disabled' : '' ; ?> type="email" class="form-control" id="floatingInput"
                                                    placeholder="name@example.com" name="username" required
                                                    value="<?php echo $row['username'] ?>">
                                                <label for="floatingInput"> Username juga</label>
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-floating mb-3">
                                                <select class="form-select" aria-label="Default select example" required
                                                    ...
                                                    foreach ($data as $key => $value) {
                                                        if ($row['level'] == $key + 1) {
                                                            echo "<option selected value=" . ($key + 1) . ">$value - $key</option>";
                                                        } else {
                                                            echo "<option value=" . ($key + 1) . ">$value + $key</option>";
                                                        }
                                                    }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-floating mb-3">
                                                <input type="number" class="form-control" id="floatingInput"
                                                    placeholder="08xxxx" name="nohp" required
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_delete_user.php"
                                    ...
                                    <div class="col-lg-12">
                                        <?php
                                        if($row['username'] == $_SESSION['username_altaca']){
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-danger" name="input_user_validate"
                                            value="12345" <?php echo ($row['username'] == $_SESSION['username_altaca']) ? 'disabled' : '' ;?>>Hapus</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                                ...
                                <form class="needs-validation" novalidate action="proses/proses_reset_password.php"
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        if($row['username'] == $_SESSION['username_altaca']){
                                            ...
                                            echo "Apakah anda yakin ingin mereset password dari <b>$row[nama]</b> menjadi password bawaan sistem yaitu <b>kamuaku</b>";   
                                        }
                                        ?>
                                    </div>
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-success" name="input_user_validate"
                                            value="12345" <?php echo ($row['username'] == $_SESSION['username_altaca']) ? 'disabled' : '' ;?>>Reset Password</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td class='d-flex'>
                                        ...
                                        <button class='btn btn-secondary btn-sm' data-bs-toggle="modal"
                                            data-bs-target="#ModalResetPassword<?php echo $row['id_user'] ?>"><i class="bi bi-key"></i></button>
                                    </td>
                                </tr>
                                <?php
                            }
