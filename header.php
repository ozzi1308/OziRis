<nav class="navbar navbar-expand navbar-dark bg-danger">
  <div class="container">
    <a class="navbar-brand" href=""><i class="bi bi-cup-straw"></i>Altaca</a>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end mt-2">
            ...
            <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#ModalUbahPassword"><i
                  class="bi bi-shield-lock"></i> Ubah
                Password</a></li>
      ...
      <div class="modal-body">
        <form class="needs-validation" novalidate action="proses/proses_ubah_password.php" method="POST">
            ...
            <div class="col-lg-6">
              <div class="form-floating mb-3">
                <input disabled type="email" class="form-control" id="floatingInput" placeholder="name@example.com"
                  name="username" required value="<?php echo $_SESSION['username_altaca'] ?>">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="form-floating mb-3">
                <input type="password" class="form-control" id="floatingPassword" name="konfirmasipassword" required>
