...
$query = mysqli_query($conn, 'SELECT tb_pesanan.*,username, SUM(harga*jumlah) AS harganya FROM tb_pesanan
    LEFT JOIN tb_user ON tb_user.id_user = tb_pesanan.pelayan 
    LEFT JOIN tb_list_pesanan ON tb_list_pesanan.pesanan = tb_pesanan.id_pesanan
    LEFT JOIN tb_daftar_menu ON tb_daftar_menu.id = tb_list_pesanan.menu
    GROUP BY id_pesanan');
        ...
        <div class="card-body">
            <div class='row'>
                <div class='col d-flex justify-content-end'>
                    <button class='btn btn-primary' data-bs-toggle="modal" data-bs-target="#ModalInputMenu"> Tambah
                        Menu</button>
                </div>
            </div>
            <!-- Modal Tambah Makanan dan Minuman -->
            <div class="modal fade" id="ModalInputMenu" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-xl modal-fullscreen-md-down">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Makanan dan Minuman</h1>
            ...
            <!-- End Modal Tambah Makanan dan Minuman -->
